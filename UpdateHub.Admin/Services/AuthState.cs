...
namespace UpdateHub.Admin.Services;
...
public sealed class AuthState(HttpClient http, IJSRuntime js)
{
    ...
    public bool IsAdmin => Role == nameof(Shared.Enums.UserRole.Admin);
    ...
    public async Task<string?> LoginAsync(string username, string password)
    {
        ...
        if (pairs.GetValueOrDefault("role") != nameof(Shared.Enums.UserRole.Admin))
        {
