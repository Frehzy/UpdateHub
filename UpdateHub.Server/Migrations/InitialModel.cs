...
internal static class InitialModel
{
    ...
    {
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.ClientBlockHistoryEntity", b =>
        {
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.ClientComputerInfoEntity", b =>
        {
            b.Property<string>("Id")
                .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.ClientEntity", b =>
        {
            b.Property<string>("Id")
                .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.ClientHistoryEntity", b =>
        {
            b.Property<int>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("INTEGER");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.ClientNetworkInfoEntity", b =>
        {
            b.Property<string>("Id")
                .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.EnrollmentRequestEntity", b =>
        {
            b.Property<string>("Id")
                .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.FileChangeEntity", b =>
        {
            b.Property<int>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("INTEGER");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.GroupEntity", b =>
        {
            b.Property<string>("Id")
                .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.ManifestEntryEntity", b =>
        {
            b.Property<string>("Id")
                .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.RefreshTokenEntity", b =>
        {
            b.Property<string>("Id")
                .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.UpdateDetailEntity", b =>
        {
            b.Property<int>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("INTEGER");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.UpdateRequestEntity", b =>
        {
            b.Property<int>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("INTEGER");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.UserClientAccessEntity", b =>
        {
            b.Property<string>("Id")
                .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.UserEntity", b =>
        {
            b.Property<string>("Id")
                .HasColumnType("TEXT");
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.UserGroupAccessEntity", b =>
        {
            b.Property<string>("Id")
                .HasColumnType("TEXT");
    ...
    private static void BuildRelationships(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.ClientBlockHistoryEntity", b =>
        {
            b.HasOne("UpdateHub.Server.Domain.Entities.ClientEntity", "Client")
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.ClientComputerInfoEntity", b =>
        {
            b.HasOne("UpdateHub.Server.Domain.Entities.ClientEntity", "Client")
                ...
                .HasForeignKey("UpdateHub.Server.Domain.Entities.ClientComputerInfoEntity", "ClientId")
                .OnDelete(DeleteBehavior.Cascade)
                .IsRequired();
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.ClientEntity", b =>
        {
            b.HasOne("UpdateHub.Server.Domain.Entities.GroupEntity", "Group")
                .WithMany("Clients")
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.FileChangeEntity", b =>
        {
            b.HasOne("UpdateHub.Server.Domain.Entities.ManifestEntryEntity", "ManifestEntry")
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.RefreshTokenEntity", b =>
        {
            b.HasOne("UpdateHub.Server.Domain.Entities.UserEntity", "User")
        ...
        modelBuilder.Entity("UpdateHub.Server.Domain.Entities.UpdateDetailEntity", b =>
        {
            ...
            b.HasOne("UpdateHub.Server.Domain.Entities.UpdateRequestEntity", "UpdateRequest")
                .WithMany("UpdateDetails")
